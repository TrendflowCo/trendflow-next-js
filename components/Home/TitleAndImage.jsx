...
const TitleAndImage = () => {
    ...
    return (
        ...
        <section className="mt-12 pt-8 pb-4 lg:px-12 px-4 w-full h-fit bg-dokuso-white flex flex-col items-center">
            ...
            <p className="mt-12 py-4 px-1 sm:px-0 sm:text-lg text-xl text-center text-dokuso-black">
                Our search bar is your gateway to finding the <b>perfect</b> fashion items to fit <span className="font-bold text-dokuso-blue">your</span> style. Don't limit <b>yourself</b> to the same old searches.<br/>
